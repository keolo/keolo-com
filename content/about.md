...
cover:
  image: "images/covers/profile.jpg"
---
...
<div class="testimonial-carousel-container">
 ...
 <p>Keolo brings a calm presence and a positive outlook to his work even in hectic situations. His contributions tend to uplift those around him and have been instrumental in maturing the company through a time of rapid growth."</p>
    ...
    <div class="testimonial-slide">
      <blockquote>
        <p>"I'm happy to recommend Keolo for his exceptional engineering skills and leadership abilities. As a Technical Engineering Manager, Keolo was an integral part of the team that built our innovative FinTech platform.</p>
 ...
 <p>I will definitely use him and his team for my future development needs, and would recommend Keolo to anyone."</p>
  ...
  <div class="testimonial-carousel-dots">
    <span class="testimonial-dot active" onclick="currentTestimonialSlide(1)"></span>
    <span class="testimonial-dot" onclick="currentTestimonialSlide(2)"></span>
    <span class="testimonial-dot" onclick="currentTestimonialSlide(3)"></span>
    <span class="testimonial-dot" onclick="currentTestimonialSlide(4)"></span>
    <span class="testimonial-dot" onclick="currentTestimonialSlide(5)"></span>
  </div>
</div>
...
.testimonial-carousel-wrapper {
  position: relative;
  padding: 0;
  min-height: 550px; /* Fixed height for desktop */
  display: flex;
  align-items: center;
}
...
@media (max-width: 768px) {
  .testimonial-carousel-wrapper {
    min-height: 450px; /* Slightly taller for tablet to accommodate text wrap */
  }
...
@media (max-width: 480px) {
  .testimonial-carousel-wrapper {
    min-height: 500px; /* Even taller for mobile due to narrower width */
  }
